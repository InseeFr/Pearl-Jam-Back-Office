...
import fr.insee.pearljam.api.surveyunit.dto.surveyunit.SurveyUnitDtoMappers;
...
public class ClosableSurveyUnitDto {
    ...
    public static ClosableSurveyUnitDto from(ClosableSurveyUnitCandidateView candidate, ClosableSurveyUnitView projection, String questionnaireState) {
