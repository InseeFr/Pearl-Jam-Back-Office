...
INSERT INTO visibility (
    ...
    ('OU-NORTH', 'VQS2021X00',1709324512000, 1709225354308, 1724582154308, 1709138954308, 1709052554308, 1708966154308, false, 'north-vqs@nooneknows.fr', ''),
...
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '11', 'business-id-11',TRUE, a.id, 'SIMPSONS2020X00', 'INTW1', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Ted Farmer' AND s.bs='11';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '12', 'business-id-12', TRUE, a.id, 'SIMPSONS2020X00', 'INTW1', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Cecilia Ortega' AND s.bs='12';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '25', 'business-id-25', TRUE, a.id, 'SIMPSONS2020X00', 'INTW1', s.id, 'OU-SOUTH', 123 FROM address a, sample_identifier s WHERE a.l1='Mylene Mikoton' AND s.bs='25';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '13', 'business-id-13', FALSE, a.id, 'SIMPSONS2020X00', 'INTW2', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Claude Watkins' AND s.bs='13';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '14', 'business-id-14', FALSE, a.id, 'SIMPSONS2020X00', 'INTW3', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Veronica Gill' AND s.bs='14';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '20', 'business-id-20', FALSE, a.id, 'VQS2021X00', 'INTW1', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Christine Aguilar' AND s.bs='20';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '21', 'business-id-21', FALSE, a.id, 'VQS2021X00', 'INTW2', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Louise Walker' AND s.bs='21';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '22', 'business-id-22', FALSE, a.id, 'VQS2021X00', 'INTW4', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Anthony Bennett' AND s.bs='22';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '23', 'business-id-23', FALSE, a.id, 'VQS2021X00', 'INTW4', s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Christopher Lewis' AND s.bs='23';
INSERT INTO public.survey_unit (id, display_name, priority, address_id, campaign_id, interviewer_id, sample_identifier_id, organization_unit_id, last_updated) SELECT  '24', 'business-id-24', TRUE, a.id, 'SIMPSONS2020X00', NULL, s.id, 'OU-NORTH', 123 FROM address a, sample_identifier s WHERE a.l1='Laurent Neville' AND s.bs='24';
