...
class SurveyUnitAssignedDaoAdapterTest {
    ...
    public static final String OU_1 = "OU-1";
    public static final String OU_2 = "OU-2";
    ...
    void setup() {
        ...
        OrganizationUnitDB ouDB1 = new OrganizationUnitDB();
        ouDB1.setId(OU_1);
        OrganizationUnitDB ouDB2 = new OrganizationUnitDB();
        ouDB2.setId(OU_2);
        organizationUnitRepository.save(ouDB1);
        organizationUnitRepository.save(ouDB2);
    ...
    void should_return_survey_units_assigned() {
        ...
        Page<SurveyUnitAssigned> result =
                adapter.findSurveyUnitsAssigned(List.of(CAMPAIGN_1_ID), List.of(OU_1), null, pageable);
    ...
    @Test
    void should_search_by_city_Filter_Ou() {

        Page<SurveyUnitAssigned> resultOu1 =
                adapter.findSurveyUnitsAssigned(
        ...
        assertThat(resultOu1.getContent()).hasSize(1)
                .extracting(SurveyUnitAssigned::city)
                .containsExactly("Lille");

        Page<SurveyUnitAssigned> resultOu2 =
                adapter.findSurveyUnitsAssigned(
                        List.of(CAMPAIGN_2_ID),
                        List.of(OU_2),
                        "Lille",
        ...
        assertThat(resultOu2.getContent()).hasSize(1)
                .extracting(SurveyUnitAssigned::city)
                .containsExactly("Lille");
    }
    ...
    void should_filter_by_address() {
        ...
        Page<SurveyUnitAssigned> result =
                adapter.findSurveyUnitsAssigned(List.of(CAMPAIGN_1_ID), List.of(OU_1), "paris", pageable);
