...
public class SurveyUnitAssignedService implements SurveyUnitAssignedPort {
    ...
    @Override
    public <T> T getSurveyUnitsAssigned(String userId, String campaignId, String search, Boolean viewed, Pageable pageable, SurveyUnitAssignedPresenter<T> presenter) {
