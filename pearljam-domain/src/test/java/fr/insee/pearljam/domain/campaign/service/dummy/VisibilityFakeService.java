...
public class VisibilityFakeService implements VisibilityService {
    ...
    @Override
    public void updateVisibility(Visibility visibilityToUpdate)
            throws VisibilityNotFoundException, VisibilityHasInvalidDatesException {
    ...
    public Optional<Visibility> findVisibility(String campaignId, String organizationalUnitId) {
        return visibilities.stream()
                .filter(visibility -> visibility.campaignId().equals(campaignId)
                        && visibility.organizationalUnitId().equals(organizationalUnitId))
                .findFirst();
    }
