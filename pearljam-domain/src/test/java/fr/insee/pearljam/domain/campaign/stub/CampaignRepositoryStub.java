...
public class CampaignRepositoryStub implements CampaignRepository {
    ...
    @Override public List<CampaignWithVisibility> findCampaignWithVisibilityByUserAndManagementVisibility(List<String> ouIds, String userId, Long date) { return List.of(); }
