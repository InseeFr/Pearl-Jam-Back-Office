...
import fr.insee.pearljam.message.infrastructure.rest.controller.dummy.MailFakeSender;
import fr.insee.pearljam.message.infrastructure.rest.controller.dummy.MessageFakeService;
...
class MessageControllerTest {
    ...
    void setup() {
        ...
        MessageController messageController = new MessageController(messageService, authenticatedUserService, mailSender);
