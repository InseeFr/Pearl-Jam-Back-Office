...
import fr.insee.pearljam.campaign.infrastructure.rest.controller.dummy.VisibilityFakeService;
...
import fr.insee.pearljam.surveyunit.domain.service.dummy.CommunicationRequestFakeRepository;
import fr.insee.pearljam.surveyunit.domain.service.dummy.CommunicationTemplateFakeRepository;
...
import fr.insee.pearljam.surveyunit.infrastructure.rest.dto.CommunicationRequestCreateDto;
...
import fr.insee.pearljam.surveyunit.domain.model.question.HouseholdCompositionQuestionValue;
...
import fr.insee.pearljam.surveyunit.domain.model.question.NumberOfRespondentsQuestionValue;
import fr.insee.pearljam.surveyunit.domain.model.question.OccupantQuestionValue;
import fr.insee.pearljam.surveyunit.domain.model.question.PresentInPreviousHomeQuestionValue;
...
import fr.insee.pearljam.surveyunit.infrastructure.persistence.jpa.entity.ContactOutcomeDB;
