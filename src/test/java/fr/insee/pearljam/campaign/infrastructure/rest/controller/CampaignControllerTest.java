...
import fr.insee.pearljam.campaign.infrastructure.rest.controller.dummy.CampaignFakeService;
import fr.insee.pearljam.campaign.infrastructure.rest.controller.dummy.ReferentFakeService;
...
import fr.insee.pearljam.helper.dummy.AuthenticationUserFakeService;
import fr.insee.pearljam.campaign.domain.service.exception.CampaignNotFoundException;
import fr.insee.pearljam.campaign.domain.service.exception.CampaignOnGoingException;
...
class CampaignControllerTest {
    ...
    void testGetCampaign01() throws Exception {
        CampaignResponseDto campaign = new CampaignResponseDto("id", "campaign-id", "label", null, null, "email",
                IdentificationConfiguration.HOUSEF2F, ContactOutcomeConfiguration.TEL, ContactAttemptConfiguration.F2F, false);
