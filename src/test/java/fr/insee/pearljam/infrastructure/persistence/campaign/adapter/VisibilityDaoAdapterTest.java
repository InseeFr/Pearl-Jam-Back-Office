...
class VisibilityDaoAdapterTest {
    ...
    private OrganizationUnitDB organizationUnit2;
    ...
    void setup() {
        ...
        organizationUnit = new OrganizationUnitDB("OU-SOUTHWEST", "South west", OrganizationUnitType.LOCAL);
        organizationUnit2 = new OrganizationUnitDB("OU-NORTHWEST", "North west", OrganizationUnitType.NATIONAL);
    ...
    void testGetVisibilityBySurveyUnitId() {
        ...
        SurveyUnitDB surveyUnit = new SurveyUnitDB(surveyUnitId, true, true, null,
