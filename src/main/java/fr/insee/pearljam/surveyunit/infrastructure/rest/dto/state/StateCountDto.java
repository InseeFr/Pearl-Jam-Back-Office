...
import static fr.insee.pearljam.configuration.web.Constants.STATECOUNT_CLOSED_CLOSING_CAUSE_FIELDS;
import static fr.insee.pearljam.configuration.web.Constants.STATE_COUNT_FIELDS;
