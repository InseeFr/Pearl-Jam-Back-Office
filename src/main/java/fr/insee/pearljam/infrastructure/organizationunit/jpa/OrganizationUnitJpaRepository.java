package fr.insee.pearljam.infrastructure.organizationunit.jpa;
 ...
 * 
 */
public interface OrganizationUnitJpaRepository extends JpaRepository<OrganizationUnit, String> {
