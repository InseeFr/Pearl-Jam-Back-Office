...
public class KeycloakConfig extends KeycloakWebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, Constants.API_CAMPAIGN_ID).hasAnyRole(adminRole, interviewerRole, userLocalRole, userNationalRole)
		...
		.antMatchers(HttpMethod.GET, Constants.API_INTERVIEWER_ID).hasAnyRole(adminRole)	
		...
		.antMatchers(HttpMethod.GET,Constants.API_ENUM_STATE).hasAnyRole(adminRole, userLocalRole, userNationalRole, interviewerRole)
		.antMatchers(HttpMethod.GET,Constants.API_ENUM_CONTACT_ATTEMPT).hasAnyRole(adminRole, userLocalRole, userNationalRole, interviewerRole)
		.antMatchers(HttpMethod.GET,Constants.API_ENUM_CONTACT_OUTCOME).hasAnyRole(adminRole, userLocalRole, userNationalRole, interviewerRole)
