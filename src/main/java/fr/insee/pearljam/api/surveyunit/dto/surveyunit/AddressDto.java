...
public class AddressDto {
	...
	public AddressDto(AddressDB address) {
		super();
		if (address != null) {
			this.l1 = ((InseeAddressDB) address).getL1();
			this.l2 = ((InseeAddressDB) address).getL2();
			this.l3 = ((InseeAddressDB) address).getL3();
			this.l4 = ((InseeAddressDB) address).getL4();
			this.l5 = ((InseeAddressDB) address).getL5();
			this.l6 = ((InseeAddressDB) address).getL6();
			this.l7 = ((InseeAddressDB) address).getL7();
			this.elevator = ((InseeAddressDB) address).getElevator();
			this.building = ((InseeAddressDB) address).getBuilding();
			this.floor = ((InseeAddressDB) address).getFloor();
			this.door = ((InseeAddressDB) address).getDoor();
			this.staircase = ((InseeAddressDB) address).getStaircase();
			this.cityPriorityDistrict = ((InseeAddressDB) address).getCityPriorityDistrict();
		}
	}
