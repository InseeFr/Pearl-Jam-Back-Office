...
public class ClosingCauseController {
	...
	public ResponseEntity<ClosingCauseCountDto> getClosingCauseCount(Authentication auth,
		...
		List<String> associatedOrgUnits = utilsService.getRelatedOrganizationUnits(callerId);
		...
		if (StringUtils.isBlank(callerId)) {
			...
			try {
				closingCountDto = closingCauseService.getClosingCauseCount(callerId, id, idep, date,
						associatedOrgUnits);
