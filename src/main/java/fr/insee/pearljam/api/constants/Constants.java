...
public class Constants {
  ...
  public static final String ERR_NO_OU_FOR_CAMPAIGN = "There is no Organisation Unit for Campaign {} affiliated to user {}";
	...
	public static final List<String> STATE_COUNT_FIELDS = List.of(NVM_COUNT, NNS_COUNT, ANV_COUNT, VIN_COUNT,
			VIC_COUNT,
			PRC_COUNT, AOC_COUNT, APS_COUNT, INS_COUNT, WFT_COUNT, WFS_COUNT, TBR_COUNT, FIN_COUNT, CLO_COUNT,
			NVA_COUNT, TOTAL_COUNT);

	public static final List<String> STATECOUNT_CLOSED_CLOSING_CAUSE_FIELDS =
			List.of(NPA_COUNT, NPI_COUNT, NPX_COUNT, ROW_COUNT);
