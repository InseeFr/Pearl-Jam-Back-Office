...
public interface VisibilityRepository extends JpaRepository<Visibility, VisibilityId> {
	...
	Optional<Visibility> findByCampaignIdIgnoreCaseAndOrganizationUnitIdIgnoreCase(String campaignId,
