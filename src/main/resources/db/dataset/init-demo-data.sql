...
INSERT INTO public.person (id, email, first_name, last_name, birthdate, title, privileged, survey_unit_id) VALUES
    (1,  'test@test.com', 'Ted',         'Farmer',      315532800000, 0, TRUE,  '11'),
    (2,  'test@test.com', 'Cecilia',     'Ortega',      325242830770, 1, TRUE,  '12'),
    (3,  'test@test.com', 'Claude',      'Watkins',     334952861540, 0, TRUE,  '13'),
    (4,  'test@test.com', 'Veronica',    'Baker',       344662892310, 1, TRUE,  '14'),
    (5,  'test@test.com', 'Christine',   'Aguilar',     354372923080, 1, FALSE, '11'),
    (6,  'test@test.com', 'Louise',      'Walker',      364082953850, 1, FALSE, '11'),
    (7,  'test@test.com', 'Anthony',     'Bennett',     373792984620, 0, FALSE, '12'),
    (8,  'test@test.com', 'Christopher', 'Lewis',       383503015390, 0, FALSE, '14'),
    (9,  'test@test.com', 'Harriette',   'Raymond',     393213046160, 1, TRUE,  '20'),
    (10, 'test@test.com', 'Aimée',       'Lamothe',     402923076930, 0, TRUE,  '21'),
    (11, 'test@test.com', 'Perrin',      'Blanchard',   412633107700, 0, TRUE,  '22'),
    (12, 'test@test.com', 'Artus',       'Arnoux',      422343138470, 0, TRUE,  '23'),
    (13, 'test@test.com', 'Isabelle',    'Moreau',      567993600020, 1, TRUE,  'PROTO01'),
    (14, 'test@test.com', 'Julien',      'Dupont',      577703630790, 0, TRUE,  'PROTO02'),
    (15, 'test@test.com', 'Sophie',      'Martin',      587413661560, 1, FALSE,  'PROTO03'),
    (16, 'test@test.com', 'Marc',        'Lefevre',     597123692330, 0, TRUE,  'PROTO04'),
    (17, 'test@test.com', 'Nathalie',    'Bernard',     606833723100, 1, FALSE,  'PROTO05'),
    (18, 'test@test.com', 'Olivier',     'Girard',      616543753870, 0, FALSE,  'PROTO06'),
    (19, 'test@test.com', 'Camille',     'Renaud',      626253784640, 1, TRUE,  'PROTO07'),
    (20, 'test@test.com', 'Pauline',     'Durand',      635963815410, 1, TRUE,  'PROTO08'),
    (21, 'test@test.com', 'Antoine',     'Morel',       645673846180, 0, TRUE,  'PROTO09'),
    (22, 'test@test.com', 'Marine',      'Lambert',     655383876950, 1, TRUE,  'PROTO10'),
    (23, 'test@test.com', 'Alexandre',   'Faure',       665093907720, 0, TRUE,  'PROTO11'),
    (24, 'test@test.com', 'Elodie',      'Renault',     674803938490, 1, TRUE,  'PROTO12'),
    (25, 'test@test.com', 'Maxime',      'Petit',       684513969260, 0, TRUE,  'PROTO13'),
    (26, 'test@test.com', 'Amélie',      'Gautier',     694224000030, 1, TRUE,  'PROTO14'),
    (27, 'test@test.com', 'Damien',      'Roux',        703934030800, 0, TRUE,  'PROTO15'),
    (28, 'test@test.com', 'Claire',      'Dubois',      713644061570, 1, TRUE,  'PROTO16'),
    (29, 'test@test.com', 'Hugo',        'Simon',       723354092340, 0, TRUE,  'PROTO17'),
    (30, 'test@test.com', 'Chloé',       'Lemoine',     733064123110, 1, TRUE,  'PROTO18'),
    (31, 'test@test.com', 'Romain',      'Bertrand',    742774153880, 0, TRUE,  'PROTO19'),
    (32, 'test@test.com', 'Alice',       'Renault',     752484184650, 1, TRUE,  'PROTO20'),
    (33, 'test@test.com', 'Guillaume',   'Faure',       762194215420, 0, TRUE,  'PROTO21'),
    (34, 'test@test.com', 'Laurent',     'Neville',     674803938490, 1, TRUE,  'PROTO22'),
    (35, 'test@test.com', 'Harry',       'Cover',       684513969260, 0, TRUE,  'PROTO23'),
    (36, 'test@test.com', 'Ella',        'Gance',       694224000030, 1, TRUE,  'PROTO24'),
    (37, 'test@test.com', 'Jean',        'Neige',       703934030800, 0, TRUE,  'PROTO25'),
    (38, 'test@test.com', 'Phil',        'Harmonie',    713644061570, 1, TRUE,  'PROTO26'),
    (39, 'test@test.com', 'Alain',       'Thé',         723354092340, 0, TRUE,  'PROTO27'),
    (40, 'test@test.com', 'Brie',        'Savarin',     733064123110, 1, TRUE,  'PROTO28'),
    (41, 'test@test.com', 'Cécile',      'Houte',       742774153880, 0, TRUE,  'PROTO29'),
    (42, 'test@test.com', 'Dan',         'Tifrice',     752484184650, 1, TRUE,  'PROTO30'),
    (43, 'test@test.com', 'Emile',       'Pates',       771904246190, 0, TRUE,  'SABIANE01'),
    (44, 'test@test.com', 'Marine',      'Lefevre',     781614276960, 0, TRUE,  'SABIANE02'),
    (45, 'test@test.com', 'Thierry',     'Bernard',     791324307730, 0, TRUE,  'SABIANE03'),
    (46, 'test@test.com', 'Sylvie',      'Martin',      801034338500, 0, TRUE,  'SABIANE04'),
    (47, 'test@test.com', 'Laurence',    'Girard',      810744369270, 0, TRUE,  'SABIANE05'),
    (48, 'test@test.com', 'Dominique',   'Moreau',      820454400040, 0, TRUE,  'SABIANE06'),
    (49, 'test@test.com', 'Juliette',    'Roussel',     830164430810, 0, TRUE,  'SABIANE07'),
    (50, 'test@test.com', 'Pascal',      'Dubois',      839874461580, 0, TRUE,  'SABIANE08'),
    (51, 'test@test.com', 'Amandine',    'Perrin',      849584492350, 0, TRUE,  'SABIANE09'),
    (52, 'test@test.com', 'Nicolas',     'Lambert',     859294523120, 0, TRUE,  'SABIANE10'),
    (53, 'test@test.com', 'Bruno',       'Simon',       869004553890, 0, TRUE,  'SABIANE11'),
    (54, 'test@test.com', 'Véronique',   'Petit',       878714584660, 0, TRUE,  'SABIANE12'),
    (55, 'test@test.com', 'Philippe',    'Garnier',     888424615430, 0, TRUE,  'SABIANE13'),
    (56, 'test@test.com', 'Catherine',   'Renault',     898134646200, 0, TRUE,  'SABIANE14'),
    (57, 'test@test.com', 'Jacques',     'Faure',       907844676970, 0, TRUE,  'SABIANE15'),
    (58, 'test@test.com', 'Marion',      'Cotille',     917554707740, 1, FALSE, 'PROTO01'),
    (59, 'test@test.com', 'Arthur',      'Couyer',      927264738510, 1, TRUE, 'PROTO03'),
    (60, 'test@test.com', 'Kaa',         'Melott',      936974769280, 0, TRUE, 'PROTO05'),
    (61, 'test@test.com', 'Père',        'Seval',       946684800050, 0, TRUE, 'PROTO06');
