...
INSERT INTO public.state (id, date, type, survey_unit_id) VALUES
    (1, 1741521600000, 'NNS', '11'),
    (2, 1741521660000, 'VIN', '11'),
    (3, 1741521720000, 'TBR', '11'),
    (4, 1741521780000, 'TBR', '12'),
    (5, 1741521840000, 'TBR', '13'),
    (6, 1741521900000, 'TBR', '14'),
    (7, 1741521960000, 'VIC', '20'),
    (8, 1741522020000, 'VIC', '21'),
    (9, 1741522080000, 'FIN', '22'),
    (10, 1741522140000, 'VIC', '23'),
    (11, 1741522200000, 'TBR', '24'),
    (12, 1741522260000, 'NNS', '25'),
    (13, 1741522320000, 'VIN', '25'),
    (14, 1741522380000, 'TBR', '25'),
    (15, 1741522440000, 'TBR', '26'),
    (16, 1741522500000, 'TBR', '27'),
    (17, 1741522560000, 'TBR', '28'),
    (18, 1741522620000, 'VIC', '29'),
    (19, 1741522680000, 'VIC', '30'),
    (20, 1741522740000, 'FIN', '31'),
    (21, 1741522800000, 'VIC', '32'),
    (22, 1741522860000, 'TBR', '33'),
    (23, 1741523100000, 'NVM', 'PROTO02'),
    (24, 1741523106000, 'NNS', 'PROTO02'),
    (25, 1741523112000, 'ANV', 'PROTO02'),
    (26, 1741523118000, 'VIN', 'PROTO02'),
    (27, 1741523124000, 'VIC', 'PROTO02'),
    (28, 1741523130000, 'PRC', 'PROTO02'),
    (29, 1741523136000, 'INS', 'PROTO02'),
    (30, 1741523142000, 'WFT', 'PROTO02'),
    (31, 1741523148000, 'WFS', 'PROTO02'),
    (32, 1741523154000, 'FIN', 'PROTO02'),
    (33, 1741523160000, 'TBR', 'PROTO02'),
    (34, 1741523200000, 'NVM', 'PROTO03'),
    (35, 1741523206000, 'NNS', 'PROTO03'),
    (36, 1741523212000, 'ANV', 'PROTO03'),
    (37, 1741523218000, 'VIN', 'PROTO03'),
    (38, 1741523224000, 'VIC', 'PROTO03'),
    (39, 1741523230000, 'PRC', 'PROTO03'),
    (40, 1741523236000, 'INS', 'PROTO03'),
    (41, 1741523400000, 'NVM', 'PROTO05'),
    (42, 1741523406000, 'NNS', 'PROTO05'),
    (43, 1741523412000, 'ANV', 'PROTO05'),
    (44, 1741523418000, 'VIN', 'PROTO05'),
    (45, 1741523424000, 'VIC', 'PROTO05'),
    (46, 1741523430000, 'PRC', 'PROTO05'),
    (47, 1741523436000, 'INS', 'PROTO05'),
    (48, 1741523500000, 'NVM', 'PROTO06'),
    (49, 1741523506000, 'NNS', 'PROTO06'),
    (50, 1741523512000, 'ANV', 'PROTO06'),
    (51, 1741523518000, 'VIN', 'PROTO06'),
    (52, 1741523524000, 'VIC', 'PROTO06'),
    (53, 1741523530000, 'PRC', 'PROTO06'),
    (54, 1741523536000, 'INS', 'PROTO06'),
    (55, 1741523542000, 'WFT', 'PROTO06'),
    (56, 1741523548000, 'WFS', 'PROTO06'),
    (57, 1741523554000, 'FIN', 'PROTO06'),
    (58, 1741523560000, 'TBR', 'PROTO06'),
    (59, 1741523600000, 'NVM', 'PROTO07'),
    (60, 1741523606000, 'NNS', 'PROTO07'),
    (61, 1741523612000, 'ANV', 'PROTO07'),
    (62, 1741523618000, 'VIN', 'PROTO07'),
    (63, 1741523624000, 'VIC', 'PROTO07'),
    (64, 1741523630000, 'PRC', 'PROTO07'),
    (65, 1741523636000, 'INS', 'PROTO07'),
    (66, 1741523700000, 'NVM', 'PROTO08'),
    (67, 1741523706000, 'NNS', 'PROTO08'),
    (68, 1741523712000, 'ANV', 'PROTO08'),
    (69, 1741523718000, 'VIN', 'PROTO08'),
    (70, 1741523724000, 'VIC', 'PROTO08'),
    (71, 1741523730000, 'PRC', 'PROTO08'),
    (72, 1741523736000, 'INS', 'PROTO08'),
    (73, 1741523742000, 'WFT', 'PROTO08'),
    (74, 1741523748000, 'WFS', 'PROTO08'),
    (75, 1741523754000, 'FIN', 'PROTO08'),
    (76, 1741523760000, 'TBR', 'PROTO08'),
    (77, 1741523800000, 'NVM', 'PROTO09'),
    (78, 1741523806000, 'NNS', 'PROTO09'),
    (79, 1741523812000, 'ANV', 'PROTO09'),
    (80, 1741523818000, 'VIN', 'PROTO09'),
    (81, 1741523824000, 'VIC', 'PROTO09'),
    (82, 1741523830000, 'PRC', 'PROTO09'),
    (83, 1741523836000, 'INS', 'PROTO09'),
    (84, 1741523900000, 'NVM', 'PROTO10'),
    (85, 1741523906000, 'NNS', 'PROTO10'),
    (86, 1741523912000, 'ANV', 'PROTO10'),
    (87, 1741523918000, 'VIN', 'PROTO10'),
    (88, 1741523924000, 'VIC', 'PROTO10'),
    (89, 1741523930000, 'PRC', 'PROTO10'),
    (90, 1741523936000, 'INS', 'PROTO10'),
    (91, 1741524000000, 'NVM', 'PROTO11'),
    (92, 1741524006000, 'NNS', 'PROTO11'),
    (93, 1741524012000, 'ANV', 'PROTO11'),
    (94, 1741524018000, 'VIN', 'PROTO11'),
    (95, 1741524024000, 'VIC', 'PROTO11'),
    (96, 1741524030000, 'PRC', 'PROTO11'),
    (97, 1741524036000, 'INS', 'PROTO11'),
    (98, 1741524100000, 'NVM', 'PROTO12'),
    (99, 1741524106000, 'NNS', 'PROTO12'),
    (100, 1741524112000, 'ANV', 'PROTO12'),
    (101, 1741524118000, 'VIN', 'PROTO12'),
    (102, 1741524124000, 'VIC', 'PROTO12'),
    (103, 1741524130000, 'PRC', 'PROTO12'),
    (104, 1741524136000, 'INS', 'PROTO12'),
    (105, 1741524200000, 'NVM', 'PROTO13'),
    (106, 1741524206000, 'NNS', 'PROTO13'),
    (107, 1741524212000, 'ANV', 'PROTO13'),
    (108, 1741524218000, 'VIN', 'PROTO13'),
    (109, 1741524224000, 'VIC', 'PROTO13'),
    (110, 1741524230000, 'PRC', 'PROTO13'),
    (111, 1741524236000, 'INS', 'PROTO13'),
    (112, 1741524242000, 'WFT', 'PROTO13'),
    (113, 1741524248000, 'WFS', 'PROTO13'),
    (114, 1741524254000, 'FIN', 'PROTO13'),
    (115, 1741524300000, 'NVM', 'PROTO14'),
    (116, 1741524306000, 'NNS', 'PROTO14'),
    (117, 1741524312000, 'ANV', 'PROTO14'),
    (118, 1741524318000, 'VIN', 'PROTO14'),
    (119, 1741524324000, 'VIC', 'PROTO14'),
    (120, 1741524330000, 'PRC', 'PROTO14'),
    (121, 1741524336000, 'INS', 'PROTO14'),
    (122, 1741524400000, 'NVM', 'PROTO15'),
    (123, 1741524406000, 'NNS', 'PROTO15'),
    (124, 1741524412000, 'ANV', 'PROTO15'),
    (125, 1741524418000, 'VIN', 'PROTO15'),
    (126, 1741524424000, 'VIC', 'PROTO15'),
    (127, 1741524430000, 'PRC', 'PROTO15'),
    (128, 1741524436000, 'INS', 'PROTO15'),
    (129, 1741524500000, 'NVM', 'PROTO16'),
    (130, 1741524506000, 'NNS', 'PROTO16'),
    (131, 1741524512000, 'ANV', 'PROTO16'),
    (132, 1741524518000, 'VIN', 'PROTO16'),
    (133, 1741524524000, 'VIC', 'PROTO16'),
    (134, 1741524530000, 'PRC', 'PROTO16'),
    (135, 1741524536000, 'INS', 'PROTO16'),
    (136, 1741524542000, 'WFT', 'PROTO16'),
    (137, 1741524548000, 'WFS', 'PROTO16'),
    (138, 1741524554000, 'FIN', 'PROTO16'),
    (139, 1741524560000, 'TBR', 'PROTO16'),
    (140, 1741524600000, 'NVM', 'PROTO17'),
    (141, 1741524606000, 'NNS', 'PROTO17'),
    (142, 1741524612000, 'ANV', 'PROTO17'),
    (143, 1741524618000, 'VIN', 'PROTO17'),
    (144, 1741524624000, 'VIC', 'PROTO17'),
    (145, 1741524630000, 'PRC', 'PROTO17'),
    (146, 1741524636000, 'INS', 'PROTO17'),
    (147, 1741524700000, 'NVM', 'PROTO18'),
    (148, 1741524706000, 'NNS', 'PROTO18'),
    (149, 1741524712000, 'ANV', 'PROTO18'),
    (150, 1741524718000, 'VIN', 'PROTO18'),
    (151, 1741524724000, 'VIC', 'PROTO18'),
    (152, 1741524730000, 'PRC', 'PROTO18'),
    (153, 1741524736000, 'INS', 'PROTO18'),
    (154, 1741524800000, 'NVM', 'PROTO19'),
    (155, 1741524806000, 'NNS', 'PROTO19'),
    (156, 1741524812000, 'ANV', 'PROTO19'),
    (157, 1741524818000, 'VIN', 'PROTO19'),
    (158, 1741524824000, 'VIC', 'PROTO19'),
    (159, 1741524830000, 'PRC', 'PROTO19'),
    (160, 1741524836000, 'INS', 'PROTO19'),
    (161, 1741524842000, 'WFT', 'PROTO19'),
    (162, 1741524848000, 'WFS', 'PROTO19'),
    (163, 1741524854000, 'FIN', 'PROTO19'),
    (164, 1741524900000, 'NVM', 'PROTO20'),
    (165, 1741524906000, 'NNS', 'PROTO20'),
    (166, 1741524912000, 'ANV', 'PROTO20'),
    (167, 1741524918000, 'VIN', 'PROTO20'),
    (168, 1741524924000, 'VIC', 'PROTO20'),
    (169, 1741524930000, 'PRC', 'PROTO20'),
    (170, 1741524936000, 'INS', 'PROTO20'),
    (171, 1741525000000, 'NVM', 'PROTO21'),
    (172, 1741525006000, 'NNS', 'PROTO21'),
    (173, 1741525012000, 'ANV', 'PROTO21'),
    (174, 1741525018000, 'VIN', 'PROTO21'),
    (175, 1741525024000, 'VIC', 'PROTO21'),
    (176, 1741525030000, 'PRC', 'PROTO21'),
    (177, 1741525036000, 'INS', 'PROTO21'),
    (178, 1741524300000, 'NVM', 'SABIANE01'),
    (179, 1741524306000, 'NNS', 'SABIANE01'),
    (180, 1741524312000, 'ANV', 'SABIANE01'),
    (181, 1741524318000, 'VIN', 'SABIANE01'),
    (182, 1741524324000, 'VIC', 'SABIANE01'),
    (183, 1741524330000, 'PRC', 'SABIANE01'),
    (184, 1741524360000, 'NVM', 'SABIANE02'),
    (185, 1741524366000, 'NNS', 'SABIANE02'),
    (186, 1741524372000, 'ANV', 'SABIANE02'),
    (187, 1741524378000, 'VIN', 'SABIANE02'),
    (188, 1741524384000, 'VIC', 'SABIANE02'),
    (189, 1741524390000, 'PRC', 'SABIANE02'),
    (190, 1741524420000, 'NVM', 'SABIANE03'),
    (191, 1741524426000, 'NNS', 'SABIANE03'),
    (192, 1741524432000, 'ANV', 'SABIANE03'),
    (193, 1741524438000, 'VIN', 'SABIANE03'),
    (194, 1741524444000, 'VIC', 'SABIANE03'),
    (195, 1741524450000, 'PRC', 'SABIANE03'),
    (196, 1741524480000, 'NVM', 'SABIANE04'),
    (197, 1741524486000, 'NNS', 'SABIANE04'),
    (198, 1741524492000, 'ANV', 'SABIANE04'),
    (199, 1741524498000, 'VIN', 'SABIANE04'),
    (200, 1741524504000, 'VIC', 'SABIANE04'),
    (201, 1741524510000, 'PRC', 'SABIANE04'),
    (202, 1741524540000, 'NVM', 'SABIANE05'),
    (203, 1741524546000, 'NNS', 'SABIANE05'),
    (204, 1741524552000, 'ANV', 'SABIANE05'),
    (205, 1741524558000, 'VIN', 'SABIANE05'),
    (206, 1741524564000, 'VIC', 'SABIANE05'),
    (207, 1741524570000, 'PRC', 'SABIANE05'),
    (208, 1741524600000, 'NVM', 'SABIANE06'),
    (209, 1741524606000, 'NNS', 'SABIANE06'),
    (210, 1741524612000, 'ANV', 'SABIANE06'),
    (211, 1741524618000, 'VIN', 'SABIANE06'),
    (212, 1741524624000, 'VIC', 'SABIANE06'),
    (213, 1741524630000, 'PRC', 'SABIANE06'),
    (214, 1741524660000, 'NVM', 'SABIANE07'),
    (215, 1741524666000, 'NNS', 'SABIANE07'),
    (216, 1741524672000, 'ANV', 'SABIANE07'),
    (217, 1741524678000, 'VIN', 'SABIANE07'),
    (218, 1741524684000, 'VIC', 'SABIANE07'),
    (219, 1741524690000, 'PRC', 'SABIANE07'),
    (220, 1741524720000, 'NVM', 'SABIANE08'),
    (221, 1741524726000, 'NNS', 'SABIANE08'),
    (222, 1741524732000, 'ANV', 'SABIANE08'),
    (223, 1741524738000, 'VIN', 'SABIANE08'),
    (224, 1741524744000, 'VIC', 'SABIANE08'),
    (225, 1741524750000, 'PRC', 'SABIANE08'),
    (226, 1741524780000, 'NVM', 'SABIANE09'),
    (227, 1741524786000, 'NNS', 'SABIANE09'),
    (228, 1741524792000, 'ANV', 'SABIANE09'),
    (229, 1741524798000, 'VIN', 'SABIANE09'),
    (230, 1741524804000, 'VIC', 'SABIANE09'),
    (231, 1741524810000, 'PRC', 'SABIANE09'),
    (232, 1741524840000, 'NVM', 'SABIANE10'),
    (233, 1741524846000, 'NNS', 'SABIANE10'),
    (234, 1741524852000, 'ANV', 'SABIANE10'),
    (235, 1741524858000, 'VIN', 'SABIANE10'),
    (236, 1741524864000, 'VIC', 'SABIANE10'),
    (237, 1741524870000, 'PRC', 'SABIANE10'),
    (238, 1741524900000, 'NVM', 'SABIANE11'),
    (239, 1741524906000, 'NNS', 'SABIANE11'),
    (240, 1741524912000, 'ANV', 'SABIANE11'),
    (241, 1741524918000, 'VIN', 'SABIANE11'),
    (242, 1741524924000, 'VIC', 'SABIANE11'),
    (243, 1741524930000, 'PRC', 'SABIANE11'),
    (244, 1741524960000, 'NVM', 'SABIANE12'),
    (245, 1741524966000, 'NNS', 'SABIANE12'),
    (246, 1741524972000, 'ANV', 'SABIANE12'),
    (247, 1741524978000, 'VIN', 'SABIANE12'),
    (248, 1741524984000, 'VIC', 'SABIANE12'),
    (249, 1741524990000, 'PRC', 'SABIANE12'),
    (250, 1741525020000, 'NVM', 'SABIANE13'),
    (251, 1741525026000, 'NNS', 'SABIANE13'),
    (252, 1741525032000, 'ANV', 'SABIANE13'),
    (253, 1741525038000, 'VIN', 'SABIANE13'),
    (254, 1741525044000, 'VIC', 'SABIANE13'),
    (255, 1741525050000, 'PRC', 'SABIANE13'),
    (256, 1741525080000, 'NVM', 'SABIANE14'),
    (257, 1741525086000, 'NNS', 'SABIANE14'),
    (258, 1741525092000, 'ANV', 'SABIANE14'),
    (259, 1741525098000, 'VIN', 'SABIANE14'),
    (260, 1741525104000, 'VIC', 'SABIANE14'),
    (261, 1741525110000, 'PRC', 'SABIANE14'),
    (262, 1741525140000, 'NVM', 'SABIANE15'),
    (263, 1741525146000, 'NNS', 'SABIANE15'),
    (264, 1741525152000, 'ANV', 'SABIANE15'),
    (265, 1741525158000, 'VIN', 'SABIANE15'),
    (266, 1741525164000, 'VIC', 'SABIANE15'),
    (267, 1741525170000, 'PRC', 'SABIANE15');
...
INSERT INTO public.identification (id, survey_unit_id, identification_type, identification, access, situation, category, occupant) VALUES
    ...
    (9, '24', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (10, '25', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (11, '26', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (12, '27', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (13, '28', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (14, '29', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (15, '30', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (16, '31', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (17, '32', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (18, '33', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (19, 'PROTO01', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (20, 'PROTO02', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (21, 'PROTO03', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (22, 'PROTO04', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (23, 'PROTO05', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (24, 'PROTO06', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (25, 'PROTO07', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (26, 'PROTO08', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (27, 'PROTO09', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (28, 'PROTO10', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (29, 'PROTO11', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (30, 'PROTO12', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (31, 'PROTO13', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (32, 'PROTO14', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (33, 'PROTO15', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (34, 'PROTO16', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (35, 'PROTO17', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (36, 'PROTO18', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (37, 'PROTO19', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (38, 'PROTO20', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (39, 'PROTO21', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (40, 'SABIANE01', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (41, 'SABIANE02', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (42, 'SABIANE03', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (43, 'SABIANE04', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (44, 'SABIANE05', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (45, 'SABIANE06', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (46, 'SABIANE07', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (47, 'SABIANE08', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (48, 'SABIANE09', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (49, 'SABIANE10', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (50, 'SABIANE11', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (51, 'SABIANE12', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (52, 'SABIANE13', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (53, 'SABIANE14', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED'),
    (54, 'SABIANE15', 'HOUSEF2F', 'IDENTIFIED', 'ACC', 'ORDINARY', 'PRIMARY', 'IDENTIFIED');
