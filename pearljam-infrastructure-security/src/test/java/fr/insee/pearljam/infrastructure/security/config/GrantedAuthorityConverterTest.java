...
class GrantedAuthorityConverterTest {
    ...
    private static final String JWT_ROLE_LOCAL_USER = "localUser";
    private static final String JWT_ROLE_NATIONAL_USER = "nationalUser";
    private static final String JWT_ROLE_ADMIN = "admin";
    private static final String JWT_ROLE_WEBCLIENT = "webclient";

    @BeforeEach
    void init() {
        roleProperties = new RoleProperties(JWT_ROLE_INTERVIEWER, JWT_ROLE_LOCAL_USER, JWT_ROLE_NATIONAL_USER, JWT_ROLE_ADMIN, JWT_ROLE_WEBCLIENT);
    ...
    void testConverter01() {
        roleProperties = new RoleProperties("", null, JWT_ROLE_NATIONAL_USER, JWT_ROLE_ADMIN, JWT_ROLE_WEBCLIENT);
        converter = new GrantedAuthorityConverter(roleProperties);
    ...
    private static Stream<Arguments> provideJWTRoleWithAppRoleAssociated() {
        return Stream.of(
                Arguments.of(JWT_ROLE_INTERVIEWER, AuthorityRole.INTERVIEWER),
                Arguments.of(JWT_ROLE_LOCAL_USER, AuthorityRole.LOCAL_USER),
                Arguments.of(JWT_ROLE_NATIONAL_USER, AuthorityRole.NATIONAL_USER),
                Arguments.of(JWT_ROLE_ADMIN, AuthorityRole.ADMIN),
                Arguments.of(JWT_ROLE_WEBCLIENT, AuthorityRole.WEBCLIENT));
    }
