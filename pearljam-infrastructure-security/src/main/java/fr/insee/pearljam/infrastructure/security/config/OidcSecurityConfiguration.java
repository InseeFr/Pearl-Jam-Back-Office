	...
	private void authorizeRequests(HttpSecurity http) {
		...
		http
				.authorizeHttpRequests(configurer -> configurer
						...
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_CAMPAIGNS_PHASE)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						...
						.hasRole(adminRole)
						.requestMatchers(HttpMethod.POST, Constants.API_ADMIN_REPORTING_SNAPSHOT)
						.hasRole(adminRole)
						.requestMatchers(HttpMethod.GET, Constants.API_ADMIN_SURVEYUNIT_DETAILS)
						.hasAnyRole(adminRole, webclientRole)
						.requestMatchers(HttpMethod.POST, Constants.API_ADMIN_SURVEYUNITS_DETAILS)
						.hasAnyRole(adminRole, webclientRole)
						.requestMatchers(HttpMethod.GET, Constants.API_CAMPAIGN_ID_PORTAL_DATA)
						.hasAnyRole(adminRole, localUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_CAMPAIGNS_PROGRESS)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_CAMPAIGNS_PROGRESS_EXPORT)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						...
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_INTERVIEWERS_PROGRESS_EXPORT)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_OUS_PROGRESS)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_OUS_PROGRESS_EXPORT)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						...
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_CAMPAIGN_INTERVIEWERS_CLOSING_CAUSES)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_REPORTING_INTERVIEWERS_CAMPAIGN_CLOSING_CAUSES)
						.hasAnyRole(adminRole, localUserRole, nationalUserRole)
                        ...
                        .hasAnyRole(adminRole, nationalUserRole, localUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_SURVEY_UNITS_TO_REVIEW)
						.hasAnyRole(adminRole, nationalUserRole, localUserRole)
						...
						.hasAnyRole(adminRole, nationalUserRole, localUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_CAMPAIGN_SU_COMPLETED_EXPORT)
                        .hasAnyRole(adminRole, nationalUserRole, localUserRole)
						.requestMatchers(HttpMethod.GET, Constants.API_SURVEYUNIT_HISTORY)
						.hasAnyRole(adminRole, nationalUserRole, localUserRole)
