...
class InterviewerCampaignsProgressCsvPresenterTest {

    private final InterviewerCampaignsProgressCsvPresenter presenter = new InterviewerCampaignsProgressCsvPresenter();

    @Test
    @DisplayName("Returns empty rows when no stats are provided")
    void shouldReturnEmptyRows_whenNoStats() {
        // Given / When
        InterviewerCampaignsProgressCsv csv = presenter.present(List.of());
    ...
    void shouldMapStatsPreservingOrder() {
        ...
        // When
        InterviewerCampaignsProgressCsv csv = presenter.present(List.of(stats1, stats2));
    ...
    void shouldHaveRowSizeMatchingHeaderSize() {
        ...
        // When
        InterviewerCampaignsProgressCsv csv = presenter.present(List.of(stats));
