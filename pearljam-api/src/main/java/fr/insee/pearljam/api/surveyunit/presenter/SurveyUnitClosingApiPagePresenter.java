...
/**
 * Presenter for paginated survey units to close.
 * Returns a Spring Data Page object with pagination metadata.
 */
@Component
public class SurveyUnitClosingApiPagePresenter implements PaginatedSurveyUnitClosingPresenter<Page<SurveyUnitToCloseResponse>> {
    ...
    public Page<SurveyUnitToCloseResponse> present(
        ...
        // This method should not be called directly for paginated results
