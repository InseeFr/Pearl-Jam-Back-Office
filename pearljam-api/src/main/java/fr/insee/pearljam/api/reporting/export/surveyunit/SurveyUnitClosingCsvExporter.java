...
public class SurveyUnitClosingCsvExporter {
    ...
    public ResponseEntity<byte[]> export(String userId)
        ...
        List<> surveyUnitsToClose = surveyUnitClosingPort.getSurveyUnitsToClose(userId, presenter);
        return buildResponse(csv, campaignId + "UE_à_clore" + date);
    }
