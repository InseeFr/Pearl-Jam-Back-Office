package fr.insee.pearljam.infrastructure.persistence.surveyunit.entity.identification;
...
@Entity
@Table(name = "identification", schema = "public")
...
public abstract class IdentificationDB implements Serializable {
	 ...
	 */
	@OneToOne
	protected SurveyUnitDB surveyUnit;

	protected IdentificationDB(Long id, IdentificationType identificationType, SurveyUnitDB surveyUnit) {
		this.id = id;
	...
	public static IdentificationDB fromModel(SurveyUnitDB surveyUnit,
